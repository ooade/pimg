...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_pimg__ = __webpack_require__("../../dist/pimg.es.js");
...
var Index = function (_React$Component) {
	...
	_createClass(Index, [{
		...
		value: function render() {
			var _props = this.props,
			    dataSaver = _props.dataSaver,
			    toggleDataSaver = _props.toggleDataSaver;
...
var _default = __WEBPACK_IMPORTED_MODULE_2_next_redux_wrapper___default()(__WEBPACK_IMPORTED_MODULE_3__store__["a" /* initStore */], function (_ref) {
	var dataSaver = _ref.dataSaver;
	return { dataSaver: dataSaver };
}, {
	toggleDataSaver: __WEBPACK_IMPORTED_MODULE_3__store__["b" /* toggleDataSaver */]
})(Index);
...
(function () {
	...
	reactHotLoader.register(Index, 'Index', '/home/ademola/workspace/pimg/examples/nextjs/pages/index.js');
	reactHotLoader.register(_default, 'default', '/home/ademola/workspace/pimg/examples/nextjs/pages/index.js');
	leaveModule(module);
})();
...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return toggleDataSaver; });
...
var reducer = function reducer() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { dataSaver: false };
	var action = arguments[1];
...
var toggleDataSaver = function toggleDataSaver() {
	return {
...
var initStore = function initStore() {
	var initialState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { dataSaver: true };

	return Object(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* createStore */])(reducer, initialState);
};
;
...
(function () {
	...
	reactHotLoader.register(reducer, 'reducer', '/home/ademola/workspace/pimg/examples/nextjs/store.js');
	reactHotLoader.register(toggleDataSaver, 'toggleDataSaver', '/home/ademola/workspace/pimg/examples/nextjs/store.js');
	reactHotLoader.register(initStore, 'initStore', '/home/ademola/workspace/pimg/examples/nextjs/store.js');
	leaveModule(module);
})();
